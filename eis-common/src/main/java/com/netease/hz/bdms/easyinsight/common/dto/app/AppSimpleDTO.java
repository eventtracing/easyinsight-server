...
public class AppSimpleDTO extends BaseUserListHolderDTO {
  /**
   * 产品ID
   */
  private String code;
  ...
  public AppSimpleDTO setCreateTime(Object createTime) {
    if(createTime != null) {
  ...
  public AppSimpleDTO setUpdateTime(Object updateTime) {
    if(updateTime != null) {
